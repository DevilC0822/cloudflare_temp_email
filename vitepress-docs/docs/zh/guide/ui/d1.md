...
打开 `Console` 标签页，输入仓库中 [db/schema.sql](https://github.com/DevilC0822/cloudflare_temp_email/blob/main/db/schema.sql) 文件的内容，点击 `Execute` 执行
...
查看 [更新日志](https://github.com/DevilC0822/cloudflare_temp_email/blob/main/CHANGELOG.md)
