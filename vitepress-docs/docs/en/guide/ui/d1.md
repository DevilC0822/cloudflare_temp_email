...
Open the `Console` tab, enter the content from the [db/schema.sql](https://github.com/DevilC0822/cloudflare_temp_email/blob/main/db/schema.sql) file in the repository, and click `Execute` to run it.
...
Check the [Changelog](https://github.com/DevilC0822/cloudflare_temp_email/blob/main/CHANGELOG.md)
